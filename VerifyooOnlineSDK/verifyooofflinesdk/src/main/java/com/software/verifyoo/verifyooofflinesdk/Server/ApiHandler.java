...
public class ApiHandler extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try
        {
            ...
            _urlConnection.setReadTimeout(20000);
            _urlConnection.setConnectTimeout(20000);

            _urlConnection.setRequestProperty("AppId", "358239059984288");
            _urlConnection.setRequestProperty("AppKey", "599842883582390");
