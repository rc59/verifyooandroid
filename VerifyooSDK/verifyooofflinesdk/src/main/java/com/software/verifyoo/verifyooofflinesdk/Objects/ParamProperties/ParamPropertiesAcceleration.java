 ...
 */
public class ParamPropertiesAcceleration extends ParamPropertiesAbstract {
    public ParamPropertiesAcceleration(double[] values, int length, String paramName, HashMap<String, IBaseParam> hashParams) {
